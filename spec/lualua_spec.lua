  ...
  describe('state api', function()
    ...
    describe('createtable', function()
      it('requires two arguments', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'f\' (number expected, got no value)', s.createtable, s)
        assertFails('bad argument #3 to \'f\' (number expected, got no value)', s.createtable, s, 1)
      end)
      it('works', function()
        local s = lib.newstate()
