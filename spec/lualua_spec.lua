describe('lualua', function()
  ...
  describe('state api', function()
    ...
    describe('pcall', function()
      ...
      pending('returns ERRRUN on function that errors', function()
        local s = lib.newstate()
        s:loadstring('unknown()')
        assert.same(lib.ERRRUN, nr(1, s:pcall(0, 0, 0)))
        assert.same(1, s:gettop())
      ...
      pending('fails on invalid errfunc index', function()
        local s = lib.newstate()
        s:loadstring('unknown()')
        assert.False(pcall(function()
          s:pcall(0, 0, -2)
      ...
      pending('returns ERRERR on erroring function that is also its errfunc', function()
        local s = lib.newstate()
        assert.same(0, s:loadstring('unknown()'))
        assert.same(lib.ERRERR, nr(1, s:pcall(0, 0, -1)))
      end)
      pending('returns ERRERR if errfunc is not a function', function()
        local s = lib.newstate()
        s:pushnumber(42)
        assert.same(0, s:loadstring('unknown()'))
        assert.same(lib.ERRERR, nr(1, s:pcall(0, 0, -2)))
      end)
      pending('properly invokes errfunc, only preserves first result', function()
        local s = lib.newstate()
      ...
      pending('works with lfunctions that panic the host', function()
        local s = lib.newstate()
        s:pushnumber(42)
        s:pushlfunction(function(ss)
          ss:pushnumber(99)
      ...
      pending('works with lfunctions that explicitly panic the sandbox', function()
        local s = lib.newstate()
        s:pushnumber(42)
        s:pushlfunction(function(ss)
          ss:pushstring('doh')
      ...
      pending('works with lfunctions that implicitly panic the sandbox', function()
        local s = lib.newstate()
        s:pushnumber(42)
        s:pushlfunction(function(ss)
          ss:pushstring('doh')
