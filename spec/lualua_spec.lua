describe('lualua', function()
  ...
  local function assertFails(pattern, f, ...)
    local success, msg = pcall(f, ...)
    assert.False(success)
    if msg:sub(-#pattern) ~= pattern then
      error('error did not match pattern: ' .. msg)
    end
  end
  ...
  describe('newstate', function()
    ...
    it('starts with an empty global table', function()
      local s = nr(1, lib.newstate())
      s:pushnil()
      assert.same(false, s:next(lib.GLOBALSINDEX))
    end)
  ...
  describe('state api', function()
    ...
    describe('createtable', function()
      it('requires two arguments', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (number expected, got no value)', s.createtable, s)
        assertFails('bad argument #3 to \'?\' (number expected, got no value)', s.createtable, s, 1)
      end)
      it('works', function()
        local s = lib.newstate()
        nr(0, s:createtable(1, 1))
        assert.same(1, s:gettop())
      ...
      it('fails on full stack', function()
        ...
        assertFails('stack overflow', s.createtable, s, 1, 1)
      end)
    end)
    ...
    describe('error', function()
      ...
      it('works outside pushcfunction, by failing', function()
        local s = lib.newstate()
        s:pushstring('womp womp')
        assertFails('womp womp', s.error, s)
      end)
      it('works in pushcfunction', function()
        local s = lib.newstate()
        s:pushcfunction(function(ss)
    ...
    describe('getglobal', function()
      it('requires a string argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (string expected, got no value)', s.getglobal, s)
      end)
      it('works', function()
        local s = lib.newstate()
    ...
    describe('loadstring', function()
      it('requires an argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (string expected, got no value)', s.loadstring, s)
      end)
    ...
    describe('next', function()
      it('fails on invalid index', function()
        local s = lib.newstate()
        assertFails('type error', s.next, s, 1)
      end)
      it('works', function()
        local s = lib.newstate()
        s:newtable()
    ...
    describe('openlibs', function()
      it('puts "require" in the global table', function()
        local s = lib.newstate()
        nr(0, s:openlibs())
        s:getfield(lib.GLOBALSINDEX, 'require')
        assert.same(true, s:isfunction(1))
      end)
      describe('pcall', function()
        it('handles success', function()
          local s = lib.newstate()
          nr(0, s:openlibs())
          s:loadstring('return pcall(...)')
          s:pushcfunction(function(ss)
            ss:pushnumber(ss:tonumber(1) + ss:tonumber(2))
            return 1
          end)
          s:pushnumber(12)
          s:pushnumber(34)
          assert.same(0, s:pcall(3, 2, 0))
          assert.same(true, s:toboolean(-2))
          assert.same(46, s:tonumber(-1))
        end)
        it('handles host errors', function()
          local s = lib.newstate()
          nr(0, s:openlibs())
          s:loadstring('return pcall(...)')
          s:pushcfunction(function()
            error('foobar')
          end)
          assert.same(0, s:pcall(1, 2, 0))
          assert.same(false, s:toboolean(-2))
          assert.Not.Nil(s:tostring(-1):find('^spec/lualua_spec.lua:%d+: foobar$'))
        end)
        it('handles sandbox errors', function()
          local s = lib.newstate()
          nr(0, s:openlibs())
          s:loadstring('return pcall(...)')
          s:pushcfunction(function(ss)
      ...
      describe('xpcall', function()
        ...
        it('handles host errors', function()
          ...
          s:pushcfunction(function(ss)
            ss:pushstring(ss:tostring(1) .. 'bazquux')
            return 1
          end)
          assert.same(0, s:pcall(2, 2, 0))
          assert.same(false, s:toboolean(-2))
          assert.Not.Nil(s:tostring(-1):find('^spec/lualua_spec.lua:%d+: foobarbazquux$'))
        end)
        it('handles sandbox errors', function()
          local s = lib.newstate()
          nr(0, s:openlibs())
          ...
          s:pushcfunction(function(ss)
            ss:pushstring(ss:tostring(1) .. 'asdf')
            return 1
          end)
          assert.same(0, s:pcall(2, 2, 0))
          assert.same(false, s:toboolean(-2))
          assert.same('dohasdf', s:tostring(-1))
        end)
      end)
    end)
    ...
    describe('pcall', function()
      ...
      it('returns ERRERR on erroring function that is also its errfunc', function()
        ...
        assert.same(1, s:gettop())
        assert.same('error in error handling', s:tostring(1))
      end)
      it('returns ERRERR if errfunc is not a function', function()
        ...
        assert.same(2, s:gettop())
        assert.same(42, s:tonumber(1))
        assert.same('error in error handling', s:tostring(2))
      end)
    ...
    describe('pop', function()
      it('fails without an argument', function()
        local s = lib.newstate()
        s:pushnumber(42)
        assertFails('bad argument #2 to \'?\' (number expected, got no value)', s.pop, s)
      end)
      it('works', function()
        local s = lib.newstate()
        s:pushnumber(42)
    ...
    describe('pushcfunction', function()
      it('works', function()
        local s = lib.newstate()
        s:pushcfunction(function(ss)
      ...
      it('works with extra args', function()
        local s = lib.newstate()
        s:pushnumber(42)
        s:pushcfunction(function() end, 42)
        s:call(0, 0)
        assert.same(1, s:gettop())
      end)
    ...
    describe('pushnumber', function()
      it('requires an argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (number expected, got no value)', s.pushnumber, s)
      end)
      it('works', function()
        local s = lib.newstate()
      ...
      it('fails on non-number string', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (number expected, got string)', s.pushnumber, s, 'wat')
      end)
      it('fails on full stack', function()
        local s = lib.newstate()
        for _ = 1, lib.MINSTACK do
    ...
    describe('pushstring', function()
      it('requires an argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (string expected, got no value)', s.pushstring, s)
      end)
      it('works', function()
        local s = lib.newstate()
    ...
    describe('pushvalue', function()
      it('requires an argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (number expected, got no value)', s.pushvalue, s)
      end)
      it('works with strings', function()
        local s = lib.newstate()
        s:pushstring('wat')
    ...
    describe('rawget', function()
      ...
      it('fails on non-table', function()
        local s = lib.newstate()
        s:pushnumber(42)
        assertFails('type error', s.rawget, s, -1)
        assert.same(0, s:gettop())
      end)
      it('ignores metatables', function()
        local s = lib.newstate()
    ...
    describe('rawgeti', function()
      ...
      it('fails on numbers', function()
        local s = lib.newstate()
        s:pushnumber(12345)
        assertFails('type error', s.rawgeti, s, -1, 42)
      end)
      it('works', function()
        local s = lib.newstate()
        s:newtable()
    ...
    describe('rawset', function()
      ...
      it('fails on non-table', function()
        ...
        s:pushnumber(42)
        s:pushnumber(99)
        assertFails('type error', s.rawset, s, -2)
        assert.same(0, s:gettop())
      end)
    ...
    describe('rawseti', function()
      ...
      it('fails on numbers', function()
        local s = lib.newstate()
        s:pushnumber(12345)
        assertFails('type error', s.rawseti, s, -1, 42)
      end)
      it('works', function()
        local s = lib.newstate()
        s:newtable()
    ...
    describe('ref', function()
      ...
      it('fails on non-table', function()
        ...
        s:pushnumber(42)
        s:pushstring(99)
        assertFails('type error', s.ref, s, -2)
      end)
      it('works', function()
        local s = lib.newstate()
        s:newtable()
    ...
    describe('setfenv', function()
      it('fails on invalid index', function()
        local s = lib.newstate()
        assertFails('invalid index', s.setfenv, s, 0)
        assert.same(0, s:gettop())
      end)
      it('fails when trying to use a number as an environment', function()
        local s = lib.newstate()
        s:loadstring('return')
        s:pushnumber(42)
        assertFails('type error', s.setfenv, s, -2)
        assert.same(0, s:gettop())
      end)
      it('works on functions', function()
        ...
        s:loadstring('return')
        s:pushvalue(1)
        assert.same(true, nr(1, s:setfenv(-2)))
        assert.same(2, s:gettop())
        assert.same(true, s:isfunction(2))
        s:getfenv(-1)
        assert.same(true, s:equal(1, 3))
      end)
      it('returns false trying to setfenv a number', function()
        local s = lib.newstate()
        s:pushnumber(42)
        s:newtable()
        assert.same(false, nr(1, s:setfenv(-2)))
        assert.same(1, s:gettop())
        assert.same(42, s:tonumber(1))
      end)
    end)
    ...
    describe('setglobal', function()
      it('requires a string argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (string expected, got no value)', s.setglobal, s)
      end)
      it('fails on empty stack', function()
        local s = lib.newstate()
    ...
    describe('settop', function()
      it('fails without an argument', function()
        local s = lib.newstate()
        assertFails('bad argument #2 to \'?\' (number expected, got no value)', s.settop, s)
      end)
    ...
    describe('touserdata', function()
      it('returns nil on number', function()
        local s = lib.newstate()
        s:pushnumber(42)
        assert.Nil(s:touserdata(-1))
      end)
    end)
  end)
end)
